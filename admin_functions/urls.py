...
from .views import ClientCheck2View, FinanceCheck, ROrderStatusCheckView, Top5FinanceDetailsView, PaidClientListView, ClientDetailsUpdateView
...
urlpatterns = [
    ...
    path('paymenthandler3/', payment_webhook, name='paymenthandler'),
    ...
    path('razorpay-order-status/<str:client_id>/', ROrderStatusCheckView.as_view(), name='razorpay-order-status'),
    path("clients/<int:pk>/update/", ClientDetailsUpdateView.as_view(), name="client-update")
